...
#define PanSource	"labs/lab02/lab02.pml"
...
#define _nstates1	6	/* B */
#define minseq1	5
#define maxseq1	9
#define _endstate1	5

#define _nstates0	6	/* A */
#define minseq0	0
#define maxseq0	4
#define _endstate0	5
...
#define Air1	(sizeof(P1) - Offsetof(P1, tmp) - 1*sizeof(int))
...
#define Air0	(sizeof(P0) - Offsetof(P0, tmp) - 1*sizeof(int))
